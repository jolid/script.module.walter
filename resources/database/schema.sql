...
CREATE TABLE IF NOT EXISTS wt_download_queue ( "qid" INTEGER  PRIMARY KEY AUTOINCREMENT, "type" TEXT, "description" TEXT, "url" TEXT, "src" TEXT, "folder" TEXT, "uuid" TEXT, "status" INTEGER DEFAULT (0), "num" INTEGER, "ts" TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
